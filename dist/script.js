...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["VideoPlayer"]('.showup .play', '.overlay').init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["VideoPlayer"]('.module__video-item .play', '.overlay').init();
  ...
  var showUpSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["MiniSlider"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["MiniSlider"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["MiniSlider"]({
  ...
  feedSlider.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["Difference"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["Form"]('.form').init();
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(colum) {
      var count = 0;

      try {
        var items = colum.querySelectorAll(this.items);
        colum.querySelector('.plus').addEventListener('click', function () {
    ...
    key: "hideItems",
    value: function hideItems(colum) {
      try {
        colum.querySelectorAll(this.items).forEach(function (item, i, arr) {
          if (i !== arr.length - 1) {
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function checkMailInputs() {
      var mailInput = document.querySelectorAll('[type="email"]');
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(state) {
      try {
        ...
        var playCircle = blockedElem.querySelector('.play__circle');
        var playText = blockedElem.querySelector('.play__text');
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "clickListenerSlide",
    value: function clickListenerSlide(trigger, num) {
      var _this2 = this;
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        ...
        btn.parentNode.previousElementSibling.addEventListener('click', function (ev) {
          console.log(ev.target);

          if (ev.target.classList.contains('download') || ev.target.parentNode.classList.contains('download') || ev.target.parentNode.parentNode.classList.contains('download')) {
            return;
          }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        if (_this3.slides[_this3.slides.length - 1].type !== 'button') {
          ...
          var _active = _this3.slides[_this3.slides.length - 3];

          _this3.container.insertBefore(_active, _this3.slides[0]);
    ...
    value: function autoPlay() {
      ...
      this.prev.parentNode.addEventListener('mouseover', function () {
        _this4.pause = true;
      });
      this.prev.parentNode.addEventListener('mouseout', function () {
        _this4.pause = false;
      });
      this.slides.forEach(function (slide) {
